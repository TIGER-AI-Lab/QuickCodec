...
FFMPEG_CONFIG_MAK=1
FFMPEG_CONFIGURATION=--disable-doc --disable-static --disable-stripping --enable-debug=3 --enable-gpl --enable-version3 --enable-libx264 --enable-libxml2 --enable-shared --enable-sse --enable-avx --enable-avx2 --prefix=/home/bsch/QuickCodec/vendor/build/ffmpeg-7.1.1
prefix=/home/bsch/QuickCodec/vendor/build/ffmpeg-7.1.1
...
CC_IDENT=gcc 13 (Ubuntu 13.3.0-6ubuntu2~24.04)
ARCH=aarch64
INTRINSICS=neon
EXTERN_PREFIX=
CC=gcc
...
WINDRES=windres
DOXYGEN=doxygen
LDFLAGS=  -Wl,--as-needed -Wl,-z,noexecstack -Wl,-rpath-link=:libpostproc:libswresample:libswscale:libavfilter:libavdevice:libavformat:libavcodec:libavutil
LDEXEFLAGS=
LDSOFLAGS=
...
EXTRALIBS-avformat=-lm -latomic -lxml2 -lz
EXTRALIBS-avcodec=-pthread -lm -latomic -lx264 -lz
